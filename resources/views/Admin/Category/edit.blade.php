                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <form role="form" method="post"
                              action={{route('admin.categories.update', ['category' => $category->id])}} enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_ru"
                                           ...
                                           placeholder="Название для Ru" value="{{$ru_category->title}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug"
                                           ...
                                           id="slug"
                                           placeholder="Описание" value="{{$category->slug}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug_ru"
                                           ...
                                           id="slug_ru"
                                           placeholder="Описание для Ru" value="{{$ru_category->slug}}">
                                </div>
