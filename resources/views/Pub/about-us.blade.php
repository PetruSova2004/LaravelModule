								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret" href="#">Shop
										...
										<ul class="submenu dropdown-menu">
											<li><a class="dropdown-item" href="shop-grid-left-sidebar.blade.php">Shop Grid -
													Left Sidebar</a>
											</li>
											<li><a class="dropdown-item" href="shop-grid-right-sidebar.blade.php">Shop Grid -
													Right Sidebar</a>
											</li>
											<li><a class="dropdown-item" href="shop-list-left-sidebar.blade.php">Shop List -
													Left Sidebar</a>
											</li>
											<li><a class="dropdown-item" href="shop-list-right-sidebar.blade.php">Shop List -
													Right Sidebar</a>
											</li>
											<li><a class="dropdown-item" href="shop-grid-filter-on-top.blade.php">Shop Grid -
													Top Filter</a>
											</li>
											<li><a class="dropdown-item" href="shop-list-filter-on-top.blade.php">Shop List -
													Top Filter</a>
											</li>
										</ul>
									</li>
									<li><a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret" href="#">Shop
										...
										<ul class="submenu dropdown-menu">
											...
											<li><a class="dropdown-item" href="checkout-details.blade.php">Checkout
													Details</a>
											</li>
											<li><a class="dropdown-item" href="checkout-shipping.blade.php">Checkout
													Shipping</a>
											</li>
											<li><a class="dropdown-item" href="checkout-payment.blade.php">Checkout
													Payment</a>
											</li>
											<li><a class="dropdown-item" href="checkout-review.blade.php">Checkout Review</a>
											</li>
											<li><a class="dropdown-item" href="checkout-complete.blade.php">Checkout
													Complete</a>
											</li>
											<li><a class="dropdown-item" href="order-tracking.blade.php">Order Tracking</a>
											</li>
											<li><a class="dropdown-item" href="product-comparison.blade.php">Product
													Comparison</a>
											</li>
										</ul>
									</li>
									...
									<li><a class="dropdown-item" href="authentication-forgot-password.blade.php">Forgot
											Password</a>
									</li>
								</ul>
							</li>
