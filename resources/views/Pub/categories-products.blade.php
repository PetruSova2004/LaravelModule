            ...
            <section class="py-4">
                <div class="container">
                    ...
                    @if($category->subCategories()->count() < 1)
                        <h5 class="text-uppercase mb-0">Sorry we don't have products for
                            category {{$category->title}}</h5>
                    @endif
                    <h5 class="text-uppercase mb-0">Products for category {{$category->title}}</h5>
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="mb-1 product-price"><span
                                                                    class="me-1 text-decoration-line-through">${{$product->price + 75}} </span>
                                                                <span
                                                                    class="text-white fs-5">${{$product->price}}</span>
                                                            </div>
                                                                ...
                                                                @auth()
                                                                   ...
                                                                   btn-light btn-ecomm"
                                                                       href={{route('basket-products.create', ['id' => $product->id, 'user' => $user->id])}}>
                                                                        <i
                                                                            class='bx bxs-cart-add'>Add to Cart</i></a>
                                                                @endauth
