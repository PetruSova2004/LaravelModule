				...
				<section class="py-4">
					<div class="container">
						<div class="toolbox d-lg-flex align-items-center mb-3 gap-2 p-3 bg-dark-1">
							...
							<div> <a href="shop-grid-filter-on-top.blade.php" class="btn btn-light rounded-0"><i class='bx bxs-grid me-0'></i></a>
							</div>
							<div> <a href="shop-list-filter-on-top.blade.php" class="btn btn-white rounded-0"><i class='bx bx-list-ul me-0'></i></a>
							</div>
						</div>
