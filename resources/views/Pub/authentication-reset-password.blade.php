			...
			<div class="top-menu border-bottom">
			 ...
			 <nav class="navbar navbar-expand">
			  ...
			  <ul class="navbar-nav ms-auto d-none d-lg-flex">
				 <li class="nav-item">
				   <a class="nav-link" href="order-tracking.blade.php">Track Order</a>
				 </li>
				 <li class="nav-item">
				   <a class="nav-link" href="about-us.blade.php">About</a>
				 </li>
				 <li class="nav-item">
				   <a class="nav-link" href="shop-categories.blade.php">Our Stores</a>
				 </li>
				 <li class="nav-item">
				   <a class="nav-link" href="blog.blade.php">Blog</a>
				 </li>
				 <li class="nav-item">
					 <a class="nav-link" href="contact-us.blade.php">Contact</a>
				   </li>
				  <li class="nav-item">
				...
				<ul class="navbar-nav">
				 ...
				 <li class="nav-item dropdown">
				   ...
				   <div class="dropdown-menu dropdown-menu-lg-end">
						   <a class="dropdown-item d-flex allign-items-center" href="javascript:;">
							<i class="flag-icon flag-icon-de me-2"></i><span>German</span></a>
			 ...
			 <div class="container">
			   <div class="row align-items-center">
				   <div class="col col-md-auto">
					  ...
					  <div class="mobile-toggle-menu d-lg-none px-lg-2" data-trigger="#navbar_main"><i class='bx bx-menu'></i></div>
					 ...
					 <div class="top-cart-icons">
						 <nav class="navbar navbar-expand">
						  <ul class="navbar-nav ms-auto">
							 <li class="nav-item"><a href="javascript:;" class="nav-link cart-link"><i class='bx bx-user'></i></a></li>
							 <li class="nav-item"><a href="javascript:;" class="nav-link cart-link"><i class='bx bx-heart'></i></a></li>
						 ...
						 <ul class="dropdown-menu">
						   <li><a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret" href="#">Shop Layouts <i class='bx bx-chevron-right float-end'></i></a>
								<ul class="submenu dropdown-menu">
								 <li><a class="dropdown-item" href="shop-grid-left-sidebar.blade.php">Shop Grid - Left Sidebar</a></li>
								 <li><a class="dropdown-item" href="shop-grid-right-sidebar.blade.php">Shop Grid - Right Sidebar</a></li>
								 <li><a class="dropdown-item" href="shop-list-left-sidebar.blade.php">Shop List - Left Sidebar</a></li>
								 <li><a class="dropdown-item" href="shop-list-right-sidebar.blade.php">Shop List - Right Sidebar</a></li>
								 <li><a class="dropdown-item" href="shop-grid-filter-on-top.blade.php">Shop Grid - Top Filter</a></li>
								 <li><a class="dropdown-item" href="shop-list-filter-on-top.blade.php">Shop List - Top Filter</a></li>
							  </ul>
						   </li>
						   <li><a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret" href="#">Shop Pages <i class='bx bx-chevron-right float-end'></i></a>
								<ul class="submenu dropdown-menu">
								 <li><a class="dropdown-item" href="shop-cart.blade.php">Shop Cart</a></li>
								 <li><a class="dropdown-item" href="shop-categories.blade.php">Shop Categories</a></li>
								 <li><a class="dropdown-item" href="checkout-details.blade.php">Checkout Details</a></li>
								 <li><a class="dropdown-item" href="checkout-shipping.blade.php">Checkout Shipping</a></li>
								 <li><a class="dropdown-item" href="checkout-payment.blade.php">Checkout Payment</a></li>
								 <li><a class="dropdown-item" href="checkout-review.blade.php">Checkout Review</a></li>
								 <li><a class="dropdown-item" href="checkout-complete.blade.php">Checkout Complete</a></li>
								 <li><a class="dropdown-item" href="order-tracking.blade.php">Order Tracking</a></li>
								 <li><a class="dropdown-item" href="product-comparison.blade.php">Product Comparison</a></li>

							  </ul>
						   </li>
						   <li><a class="dropdown-item" href="about-us.blade.php">About Us</a></li>
						   <li><a class="dropdown-item" href="contact-us.blade.php">Contact Us</a></li>
						   <li><a class="dropdown-item" href="authentication-signin.blade.php">Sign In</a></li>
						   <li><a class="dropdown-item" href="authentication-signup.blade.php">Sign Up</a></li>
						   <li><a class="dropdown-item" href="authentication-forgot-password.blade.php">Forgot Password</a></li>
						 </ul>
					 </li>
					 <li class="nav-item"> <a class="nav-link" href="blog.blade.php">Blog </a> </li>
					 <li class="nav-item"> <a class="nav-link" href="about-us.blade.php">About Us </a> </li>
					 <li class="nav-item"> <a class="nav-link" href="contact-us.blade.php">Contact Us </a> </li>
					 <li class="nav-item"> <a class="nav-link" href="shop-categories.blade.php">Our Store</a> </li>
					 <li class="nav-item dropdown">
						 ...
						 <ul class="dropdown-menu">
						   <li><a class="dropdown-item" href="account-dashboard.blade.php">Dashboard</a></li>
						   <li><a class="dropdown-item" href="account-downloads.blade.php">Downloads</a></li>
						   <li><a class="dropdown-item" href="account-orders.blade.php">Orders</a></li>
						   <li><a class="dropdown-item" href="account-payment-methods.blade.php">Payment Methods</a></li>
						   <li><a class="dropdown-item" href="account-user-details.blade.php">User Details</a></li>
						 </ul>
					 </li>
				  </ul>
						   ...
						   <div class="download-app mt-3">
							<h6 class="mb-3 text-uppercase">Download our app</h6>
							 <div class="d-flex align-items-center gap-2">
								<a href="javascript:;"><img src="assets/images/icons/apple-store.png" class="" width="160" alt=""/></a>
								<a href="javascript:;"><img src="assets/images/icons/play-store.png" class="" width="160" alt=""/></a>
							 </div>
						   </div>
