                            ...
                            @foreach($categories as $category)
                                <div class="col">
                                    <div class="card rounded-0 product-card">
                                        <a href={{route('categories.read', ['category' => $category->id])}}>
                                            <img src="assets/images/shop-categories/01.png"
                                                ...
                                                @if($subcategory->category_id == $category->id)
                                                    <a href="javascript:;"
                                                       class="list-group-item bg-transparent d-flex justify-content-between align-items-center">
                                                        {{$subcategory->title}}
                                                        <span class="badge bg-light rounded-pill">{{$subcategory->products_count}}</span>
                                                    </a>
                                                @endif
                                            @endforeach
