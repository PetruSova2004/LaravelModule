                        ...
                        <div class="ms-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    <li class="breadcrumb-item"><a href={{route('indices.index')}}><i
                                    ...
                                    <div class="product-info-section p-3">
                                        ...
                                        <div class="d-flex align-items-center mt-3 gap-2">
                                            <h5 class="mb-0 text-decoration-line-through text-light-3">
                                                ${{$product->price}}</h5>
                                            <h4 class="mb-0">
                                                ${{ceil($product->price - ($product->price / 100 * 15))}}</h4>
                                        </div>
                                        <div class="mt-3">
                                            <h6>Discription :</h6>
                                        ...
                                        <div class="d-flex gap-2 mt-3">
                                            ...
                                            @auth()
                                            <a class="btn btn-white btn-ecomm" href={{route('basket-products.create', ['id' => $product->id, 'user' => $user->id])}}>
                    ...
                    <div class="product-more-info">
                        ...
                        <div class="tab-content pt-3">
                            <div class="tab-pane fade show active" id="discription" role="tabpanel">
                                ...
                                <p class="mb-1">Seitan aliquip quis cardigan american apparel, butcher voluptate
                                    nisi.</p>
                            </div>
                                            ...
                                            <div class="product-action mt-2">
                                                <div class="d-grid gap-2">
                                                    <a href="javascript:;" class="btn btn-light btn-ecomm"> <i
                                                        ...
                                                        href="javascript:;" class="btn btn-link btn-ecomm"><i
                                    ...
                                    <div class="card-body">
                                        <div class="product-info">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="cursor-pointer ms-auto"><span>4.9</span> <i
                                                        class="bx bxs-star text-white"></i>
                                                </div>
                                            </div>
                                            <div class="product-action mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="product-info">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="cursor-pointer ms-auto"><span>3.9</span> <i
                                                        class="bx bxs-star text-white"></i>
                                                </div>
                                            </div>
                                            <div class="product-action mt-2">
