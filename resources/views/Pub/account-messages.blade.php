                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    @foreach($contacts as $contact)
                                                        @if($contact->user_id == $user)
                                                            <tr>
                                                                <td>#{{$contact->id}}</td>
                                                                <td>{{\App\Modules\Pub\Contact\Services\ContactService::getDate($contact->created_at)}}</td>
                                                                <td>
                                                                    <div class="badge rounded-pill bg-light w-100">
                                                                        {{$contact->phone}}
                                                                    </div>
                                                                </td>
                                                                <td>{{strlen($contact->message)}}</td>
                                                                <td>
                                                                    <div class="d-flex gap-2"><a
                                                                            class="btn btn-light btn-sm rounded-0"
                                                                            href={{route('contacts.read', ['contact' => $contact->id])}}>View</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @endif
