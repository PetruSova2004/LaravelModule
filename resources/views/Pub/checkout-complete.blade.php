					...
					<div class="container">
						<div class="card py-3 mt-sm-3">
							<div class="card-body text-center">
								...
								</p><a class="btn btn-light rounded-0 mt-3 me-3" href="index.blade.php">Go back shopping</a><a class="btn btn-white rounded-0 mt-3" href="order-tracking.blade.php"><i class='bx bx-map'></i>Track order</a>
							</div>
						</div>
					</div>
				</section>
