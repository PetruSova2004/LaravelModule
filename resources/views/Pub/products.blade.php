        ...
        <div class="col-12 col-md order-4 order-md-2">
            <div class="input-group flex-nowrap px-xl-4">
                <input type="text" class="form-control w-100" placeholder="Search for Products"
                       value="{{$search ?? old('title')}}">
                <button type="submit" class="input-group-text cursor-pointer" href={{route('products.index')}}><i
                                            ...
                                            <div class="product-info">
                                                ...
                                                @foreach($subcategories as $subcategory)
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                            ...
                                                            @if(session('EUR'))
                                                                <div class="mb-1 product-price"><span
                                                                        class="me-1 text-decoration-line-through">€{{ceil(\App\Modules\Pub\Currency\Services\CurrencyService::exchange('EUR', 'USD', $product->price)->result)}}</span>
                                                                    <span
                                                                        class="text-white fs-5">${{ceil($product->price - ($product->price / 100 * 15))}}</span>
                                                                </div>
                                                            @endif
